...
def main():
    ...
    driving_img = cv2.imread(pose_video_path)
    driving_imgs = [driving_img]
    pose_frames, pose_lms_list, pose_size = lmks_imgs_extract(driving_imgs)
    pose_frames = pose_frames * 24
    pose_lms_list = pose_lms_list.repeat(24, axis=0)
